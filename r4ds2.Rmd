...
e, por fim, os carros com `mpg` maior ou igual à 22 são considerados como *bebe bem*. Como a última condição é complementar, isto é, as observações que não entrarm nas condições 
anteriores com certeza entrarão na última condição, podemos substituí-la por um simples `TRUE`.
